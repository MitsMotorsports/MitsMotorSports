...
// ---------------------- ADDED FOR 2023 (BEGIN) ----------------------

// Automatically import all .jpg images from 2023 alumni folder
const images2023 = import.meta.glob("../assets/*.jpg", { eager: true });

// Create a filename-to-URL map for 2023 images
const imageMap2023: Record<string, string> = {};
for (const path in images2023) {
  const fileName = path.split("/").pop()!;
  imageMap2023[fileName] = (images2023[path] as { default: string }).default;
}

// Alumni 2023 (im1.jpg to im6.jpg)
const alumni2023 = [
  { name: "Ayyappadas N", img: imageMap2023["im1.jpg"] },
  { name: "Basil Raju", img: imageMap2023["im2.jpg"] },
  { name: "Eldo George", img: imageMap2023["im3.jpg"] },
  { name: "Jerin J Attacheril", img: imageMap2023["im4.jpg"] },
  { name: "Roshan Prince", img: imageMap2023["im5.jpg"] },
  { name: "V Shiva", img: imageMap2023["im6.jpg"] },
];
...
const randomNames = [
  "Laveena Wels (Captain)", "Malavika N R", "Abhijith Jithesh", "Abhinand Rajesh",
  "Ananthakrishnan", "Ananthkrishnan", "Febin",
  "Kevin Paul", "Midhul Manoj", "Nandhu", "Navaneeth Menon", "Nirrosh",
  "Prithviraj K", "Sudhev P", "Vaibhav",
  "Arjun M Nair (Captain)", "Shuhaib Sadiq", "Albin Shibhu", "Adnan Razi",
  "Ajzal V A", "Athul T Sajeevan", "Basil Benny", "Harinarayanan K S",
  ...
  return (
    <div className="bg-black text-white min-h-screen overflow-x-hidden relative">
      ...
      <div className="relative z-10 py-12">
        ...
        {/* ------------------- ADDED SECTION FOR 2023 ------------------- */}
        <AlumniSection title="ALUMNI 2023" members={alumni2023} />
        {/* ------------------- END ADDED SECTION ------------------------ */}
      </div>
    </div>
  );
